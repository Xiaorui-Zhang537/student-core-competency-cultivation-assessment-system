<template>
  <div class="font-bold leading-none" :class="props.class">
    <span class="relative inline-block">
      <template v-for="sparkle in sparkles" :key="sparkle.id">
        <svg
          class="pointer-events-none absolute z-20 sparkle"
          :style="{
            left: sparkle.x,
            top: sparkle.y,
            '--delay': String(sparkle.delay) + 's',
            '--scale': String(sparkle.scale),
          } as any"
          width="21"
          height="21"
          viewBox="0 0 21 21"
