...
import {
  ...
  DocumentTextIcon, ArrowDownTrayIcon, ShieldCheckIcon,
...
const dockItems = computed(() => ([
  { key: 'dashboard', label: t('admin.sidebar.dashboard') as string, icon: HomeIcon },
  { key: 'courses', label: t('admin.sidebar.courses') as string, icon: AcademicCapIcon },
  { key: 'analytics', label: t('admin.sidebar.analytics') as string, icon: ChartBarIcon },
  { key: 'users', label: t('admin.sidebar.users') as string, icon: UsersIcon },
  { key: 'students', label: t('admin.sidebar.students') as string, icon: UsersIcon },
  { key: 'teachers', label: t('admin.sidebar.teachers') as string, icon: UserIcon },
  { key: 'reports', label: t('admin.sidebar.reports') as string, icon: DocumentTextIcon },
  { key: 'exports', label: t('admin.sidebar.exports') as string, icon: ArrowDownTrayIcon },
  { key: 'community', label: t('admin.sidebar.community') as string, icon: ShieldCheckIcon },
]))
</script>
