...
export const abilityApi = {
  ...
  getStudentLatestReportByContext: (params: { courseId?: string|number; assignmentId?: string|number; submissionId?: string|number }): Promise<any> => {
  ...
  recordTeacherAssessment: (payload: { studentId: string | number; dimensionId: string | number; score: number; assessmentType: string; relatedId?: string | number; evidence?: string }): Promise<void> => {
